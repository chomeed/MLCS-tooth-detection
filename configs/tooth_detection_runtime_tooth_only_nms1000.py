_base_ = '/home/summer23_intern1/workspace/p1/mmdetection/configs/_base_/models/cascade-rcnn_r50_fpn_tooth_only_nms1000.py'
...
test_evaluator = dict(
    ...
    outfile_prefix='./work_dirs/tooth_only_nms1000/test',
    backend_args=backend_args,
    classwise=True,
    )
...
work_dir = 'work_dirs/tooth_only_nms1000'
log_level = 'INFO'
load_from = None
resume = False
