...
if __name__ == '__main__':
    ...
    annotations_file = '/home/summer23_intern1/workspace/MLCS-tooth-detection/mmdetection/data/tooth_detection/annotations/sample.json'
    new_file = '/home/summer23_intern1/workspace/MLCS-tooth-detection/mmdetection/data/tooth_detection/annotations/sample_cleansed.json'
    data_cleanse(annotations_file, new_file)